...
@section('content')
                ...
                <div class="product-img">
                  ...
                  <div class="hover-overlay">                    
                    ...
                    <div class="product-details valign">
                      <span class="category">
                        <a 
                          href="/products/{{$product->id_subkategori}}">{{$product->subcategory->nama_subkategori}}
                        </a>
                      </span>
      ...
      <section id="promosi" class="promosi">
            ...
            <div class="row1">
                <div class="about-img">
                    <img src="/front/img/th1.jpg" alt="Tentang Kami" style="width: 75%">
                </div>
                <div class="content1">
                    <h3>The North Face</h3>
                    <p>At The North Face, you'll find our jackets, parkas, and puffers</p>
                    <a href="#" class="cta2">Shopping-Jacket</a>
                </div>
            </div>
            <div class="row2">
                <div class="content2">
                    <h3>La Sportiva</h3>
                    <p>Explore the outdoors with the best technical footwear from La sportiva</p>
                    <a href="#" class="cta3">Shopping-Shoes</a>
                </div>
                <div class="about-img2">
                    <img src="/front/img/tiva3.jpg" alt="Tentang Kami" style="width: 100%">
                </div>
            </div>
        </section>
@endsection